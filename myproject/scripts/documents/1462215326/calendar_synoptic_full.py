...
class CalendarSynopticFull(unittest.TestCase):
    def setUp(self):
    ...
    def test_calendar_synoptic_full(self):
        driver = self.driver
        driver.get(self.base_url + "/portal/site/3922c667-5672-491a-ab06-8a058d85ed95/tool/0d21e6ff-7fe2-4148-bf9b-3f2e9a82fce0")
        driver.find_element_by_css_selector("a.Mrphs-skipNav__link.js-toggle-tools-nav").click()
